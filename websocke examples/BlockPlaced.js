...
wss.on('connection', socket => {
  ...
  globalSocket.on('message', (data) => {
   ...
   //console.log('Received:', message);
    ...
    if (parsedData.header.eventName === 'BlockPlaced') {
        ...
        console.log(`${playerName} placed a ${blockType} block at coordinates x: ${coordinates.x}, y: ${coordinates.y}, z: ${coordinates.z}.`);
    }
  });
});
